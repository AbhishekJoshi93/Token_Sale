...
contract('AbhiTokenSale', function(accounts) {
   ...
   it('initializes the contract with the correct values', function() {
    return AbhiTokenSale.deployed().then(function(instance) {
...
it('facilitates token buying', function() {
  ...
  it('ends token sale', function() {
      return AbhiToken.deployed().then(function(instance) {
        ...
        assert.equal(balance.toNumber(), 999990, 'returns all unsold Abhi tokens to admin');
